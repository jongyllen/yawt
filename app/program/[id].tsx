...
import { initDatabase, startProgram, stopProgram, getNextWorkoutForProgram } from '../../src/db/database';
...
export default function ProgramDetailScreen() {
    ...
    const [nextSession, setNextSession] = useState<{ workout: Workout; weekNumber?: number; dayNumber?: number } | null>(null);
    ...
    if (!program) return <View style={styles.container}><Text style={Typography.body}>Loading...</Text></View>;
        ...
        <View style={styles.container}>
            ...
            <ScrollView style={{ flex: 1 }}>
                                ...
                                <View style={{ flex: 1 }}>
                                    ...
                                    {nextSession ? (
                                        <Text style={Typography.bodySecondary}>
                                            Next: {nextSession.weekNumber !== undefined ? `Week ${nextSession.weekNumber}, ` : ''}
                                ...
                                <View style={{ flexDirection: 'row', alignItems: 'center', gap: Spacing.sm }}>
                                    {nextSession && (
                                        ...
                                        >
                                            ...
                                            <Text style={[Typography.caption, { color: Colors.background, marginLeft: 4, fontWeight: 'bold' }]}>
                                                START NEXT
                                            </Text>
                                        </TouchableOpacity>
                                    )}
                ...
                <View style={styles.workoutsSection}>
                    <Text style={[Typography.h3, { marginBottom: Spacing.md, paddingHorizontal: Spacing.lg }]}>Workouts</Text>
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() => router.push({
                                    ...
                                    params: {
                                        ...
                                        weekNumber: activeProgram && nextSession?.workout.id === workout.id ? nextSession.weekNumber : undefined,
                                        dayNumber: activeProgram && nextSession?.workout.id === workout.id ? nextSession.dayNumber : undefined
                                    }
                                })}
                            >
