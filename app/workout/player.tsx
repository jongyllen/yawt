...
export default function WorkoutPlayer() {
  ...
  const finishEarly = () => {
    ...
    Alert.alert('End Session?', 'How would you like to exit?', [
  ...
  const loadWorkout = async () => {
    ...
    if (p) {
      ...
      if (w) {
        ...
        if (
          active &&
          active.lastWorkoutId === workoutId &&
          active.lastBlockIndex !== undefined &&
          !resumed
        ) {
          Alert.alert('Resume Workout?', 'Would you like to continue where you left off?', [
  ...
  const handleAbort = () => {
    player.setIsPaused(true);
    Alert.alert('Discard Workout?', 'Progress from this session will be lost.', [
      { text: 'Keep Going', style: 'cancel', onPress: () => player.setIsPaused(false) },
      ...
      <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
        ...
        <View style={styles.mainContent}>
          <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', width: '100%' }}>
            ...
            <Text
              style={[Typography.bodySecondary, { marginTop: Spacing.sm, textAlign: 'center' }]}
            >
    ...
    <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      ...
      <View style={styles.progressContainer}>
        <Text style={styles.blockText}>
          {player.currentBlockIndex + 1}/{workout.blocks.length} •{' '}
          {player.currentBlock.name.toUpperCase()}
        </Text>
      ...
      <View style={styles.mainContent}>
        ...
        {player.currentStep.description && (
          <Text
            style={[
              Typography.caption,
              { textAlign: 'center', color: Colors.primary, marginTop: Spacing.xs },
            ]}
          >
        ...
        {player.currentStep.instructions && (
          <View style={styles.instructionContainer}>
            ...
            {showInstructions && (
              <Text
                style={[Typography.bodySecondary, { marginTop: Spacing.xs, textAlign: 'center' }]}
              >
                {player.currentStep.instructions}
              </Text>
            )}
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity
          ...
          style={[
            styles.playButton,
            { backgroundColor: player.isPaused ? Colors.primary : Colors.surface },
          ]}
        >
          {player.isPaused ? (
            <Play color={Colors.background} size={40} />
          ) : (
            <Pause color={Colors.primary} size={40} />
          )}
        </TouchableOpacity>
