  ...
  const handleParse = async () => {
    try {
      ...
      if (error instanceof SyntaxError) {
        Alert.alert(
          'JSON Syntax Error',
          'The text you pasted is not valid JSON. Please check for missing quotes or brackets.'
        );
      } else if (error.name === 'ZodError') {
        Alert.alert(
          'Validation Error',
          'The JSON is valid but does not match the required program structure.'
        );
      } else {
      ...
      {step === 'input' ? (
        <>
          <View style={styles.tabContainer}>
            ...
            >
              <Sparkles
                color={activeTab === 'ai' ? Colors.background : Colors.textSecondary}
                size={18}
              />
            ...
            >
              <FileJson
                color={activeTab === 'manual' ? Colors.background : Colors.textSecondary}
                size={18}
              />
          ...
          {activeTab === 'ai' ? (
            ...
            <View style={styles.manualContainer}>
              <TouchableOpacity style={styles.fileButton} onPress={handleFileImport}>
                ...
                <Text style={[Typography.h3, { color: Colors.primary, marginLeft: Spacing.sm }]}>
                  Import from File
                </Text>
              </TouchableOpacity>
        ...
        pendingProgram && (
          <>
            <ProgramEditor program={pendingProgram} onUpdate={setPendingProgram} />
            ...
            <View style={styles.actionRow}>
              <TouchableOpacity style={styles.secondaryButton} onPress={handleCancelPreview}>
