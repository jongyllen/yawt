...
// Stat Card Component
function StatCard({ icon, label, value, subtitle, color = Colors.primary }: {
        ...
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
            ...
            <View style={styles.statsGrid}>
                ...
                <StatCard
                    ...
                    label="Total Time"
                    value={stats.totalMinutes > 60 ? `${Math.floor(stats.totalMinutes / 60)}h ${stats.totalMinutes % 60}m` : `${stats.totalMinutes}m`}
