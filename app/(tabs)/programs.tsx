    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.tabContainer}>
                ...
                >
                    <Library color={activeTab === 'library' ? Colors.background : Colors.textSecondary} size={18} />
                ...
                >
                    <Globe color={activeTab === 'discover' ? Colors.background : Colors.textSecondary} size={18} />
                ...
                <View style={{ flex: 1 }}>
                    {isRegistryLoading ? (
                        <View style={styles.loadingContainer}>
                            ...
                            <Text style={[Typography.bodySecondary, { marginTop: Spacing.md }]}>Updating Registry...</Text>
                        </View>
                    ) : (
                        <FlatList
                            ...
                            ListEmptyComponent={
                                <View style={styles.emptyContainer}>
                                    <Text style={Typography.bodySecondary}>Registry is empty or could not be loaded.</Text>
                                </View>
                            }
                        />
                    )}
