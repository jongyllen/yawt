  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={[Typography.bodySecondary, { marginBottom: Spacing.md }]}>
        Describe your program (e.g., "A 4-week bodyweight strength program for beginners with 3
        workouts per week") and we'll generate a prompt for you to use with an LLM.
      </Text>
